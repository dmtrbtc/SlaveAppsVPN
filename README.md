...
[![Релиз](https://img.shields.io/badge/релиз-v0.2.24-5b8def)](https://github.com/dmtrbtc/SlaveAppsVPN/releases/latest)
...
| 🪟 **Windows** (установщик) | `SlaveAppsVPN-Setup-v0.2.24.exe` | [Скачать Setup](https://github.com/dmtrbtc/SlaveAppsVPN/releases/download/v0.2.24/SlaveAppsVPN-Setup-v0.2.24.exe) |
| 🪟 **Windows** (portable) | `SlaveAppsVPN-Portable-v0.2.24.exe` | [Скачать Portable](https://github.com/dmtrbtc/SlaveAppsVPN/releases/download/v0.2.24/SlaveAppsVPN-Portable-v0.2.24.exe) |
