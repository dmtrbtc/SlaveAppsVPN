...
[![Релиз](https://img.shields.io/badge/релиз-v0.2.29-5b8def)](https://github.com/dmtrbtc/SlaveAppsVPN/releases/latest)
...
| 🪟 **Windows** (установщик) | `SlaveAppsVPN-Setup-v0.2.29.exe` | [Скачать Setup](https://github.com/dmtrbtc/SlaveAppsVPN/releases/download/v0.2.29/SlaveAppsVPN-Setup-v0.2.29.exe) |
| 🪟 **Windows** (portable) | `SlaveAppsVPN-Portable-v0.2.29.exe` | [Скачать Portable](https://github.com/dmtrbtc/SlaveAppsVPN/releases/download/v0.2.29/SlaveAppsVPN-Portable-v0.2.29.exe) |
