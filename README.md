...
[![Релиз](https://img.shields.io/badge/релиз-v0.2.28-5b8def)](https://github.com/dmtrbtc/SlaveAppsVPN/releases/latest)
...
| 🪟 **Windows** (установщик) | `SlaveAppsVPN-Setup-v0.2.28.exe` | [Скачать Setup](https://github.com/dmtrbtc/SlaveAppsVPN/releases/download/v0.2.28/SlaveAppsVPN-Setup-v0.2.28.exe) |
| 🪟 **Windows** (portable) | `SlaveAppsVPN-Portable-v0.2.28.exe` | [Скачать Portable](https://github.com/dmtrbtc/SlaveAppsVPN/releases/download/v0.2.28/SlaveAppsVPN-Portable-v0.2.28.exe) |
